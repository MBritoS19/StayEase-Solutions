...
<div id="mySidebar">
    ...
    <?php if ($usuarioTipo === 'cliente'): ?>
        <a href="quartos.php"><i class="fas fa-bed"></i> Fazer Reserva</a>
    <?php else: ?>
        <a href="consulta_quartos.php"><i class="fas fa-plus-square"></i> Gerenciar Quartos</a>
        <a href="perfil.php"><i class="fas fa-plus-square"></i> Gerenciar Reservas</a>
        <a href="funcionarios.php"><i class="fas fa-users"></i> Gerenciar Funcionários</a>
        <a href="baixas_pagamento.php"><i class="fas fa-money-check-alt"></i> Baixas de Pagamento</a>
        <!-- <a href="configuracoes_hotel.php"><i class="fas fa-money-check-alt"></i> Configurações do Hotel</a> -->


        <!-- <a href="servico_quarto.php"><i class="fas fa-concierge-bell"></i> Serviço de Quarto</a>
        <a href="funcionarios.php"><i class="fas fa-users"></i> Cadastrar Funcionário</a>
        <a href="criar_reserva.php"><i class="fas fa-calendar-plus"></i> Cadastrar Reserva</a> -->
    <?php endif; ?>
</div>
