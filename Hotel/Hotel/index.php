...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#"><i class="bi bi-building fs-4 me-2"></i>Pousada Mazin</a> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent">
  ...
  <header class="hero d-flex align-items-center">
    ...
    <div class="container hero-content text-center">
      <h1 class="display-4 fw-bold">Bem-vindo ao Pousada Mazin</h1>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 pe-0">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcRiKsx7i34nWZryfWD9QqJryrjkHZNktSuA&s" alt="Imagem representativa da Pousada Mazin, mostrando a fachada" class="img-fluid rounded mb-0" style="width: 80%; height: auto;">
            </div>
            <div class="col-md-6">
                <h2>Sobre a Pousada Mazin</h2>
                <p>Localizada no coração da cidade, a Pousada Mazin oferece uma experiência única de conforto e sofisticação. Nossa missão é proporcionar momentos inesquecíveis com serviços de alta qualidade e atendimento personalizado.</p>
